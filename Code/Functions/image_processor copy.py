...
class ImageProcessor:
    ...
    def read_images(self, directory_path:str, format_type:str) -> np.ndarray:
        ...
        **Returns:**
        - numpy.ndarray: A NumPy array containing all the images. If the images are grayscale, the array shape will be (num_files, height, width, 1). If the images are colored (e.g., RGB), the array shape will be (num_files, height, width, channels).
        ...
        **Raises:**
        ...
        imgs = np.zeros((num_files, img_height, img_width, img.shape[-1]),
